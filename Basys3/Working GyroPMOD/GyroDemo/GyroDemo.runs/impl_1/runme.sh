...
HD_PWD='C:/Users/gener/Verilog-Experiment/Basys3/GyroDemo/GyroDemo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodGYRO_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodGYRO_Demo.tcl -notrace
