...
HD_PWD='C:/Users/gener/Verilog-Experiment/Basys3/GyroDemo/GyroDemo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodGYRO_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodGYRO_Demo.tcl
